...
export async function POST(req){
 ...
 const p={...row.payload,status:"已接",driver:name,driverPhone:phone,grabPublished:false,grabClaimedBy:String(user.id),grabClaimedAt:new Date().toISOString(),_updatedAt:new Date().toISOString()};delete p._baseUpdatedAt;
